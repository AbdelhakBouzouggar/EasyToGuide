              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="col-span-1 md:col-span-1">
                  <div className="flex items-center mb-4">
                    <svg className="w-8 h-8 mr-2" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-xl font-bold text-green-400">EasyToGuide</span>
                  </div>
                ...
                <div className="col-span-1">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><Link to="/guides" className="text-gray-400 hover:text-green-400 transition-colors">Guides</Link></li>
